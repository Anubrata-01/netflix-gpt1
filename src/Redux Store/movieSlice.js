...
export const { addMovies, addMoviestoPopular, addMoviestotopRated,addCurrentMovieCredits,addCurrentMovieCast,addCurrentMovieDetails,addCurrentMovieTrailer,addSimilarMovies,addTvShows,addmoviesToMovieSection,addMovieGenre,addMoviesBasedOnGenreId,addToMyList,addGenreId} =
  movieSLice.actions;
